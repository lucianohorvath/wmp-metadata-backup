...
namespace Preston.Media
{
    public class MediaPlayer
    {
        ...
        internal void BackupLibraryData(IWMPMedia media, XmlWriter writer)
        {
            ...
            //WriteAttributeValue(writer, media, "WM/MCDI", true); // sarasa readonly
            ...
            //WriteAttributeValue(writer, media, "WM/Writer", false); // almost none of my files has a value for this
